...
public class OccurrenceResource {
	...
	@GetMapping
	public ResponseEntity<Page<OccurrenceDTO>> findByPagination(
		...
		Page<OccurrenceDTO> list = service.findAllPaged(name,pageRequest);
		return ResponseEntity.ok().body(list);
	}
	
	@RequestMapping(value = "/list", method = RequestMethod.GET)
	public ResponseEntity<List<OccurrenceDTO>> findByName(@RequestParam(value="name")String name){
