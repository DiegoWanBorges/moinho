...
INSERT INTO SECTOR(NAME) VALUES('CALDEIRA');

INSERT INTO OCCURRENCE(NAME) VALUES('NORMAL');
INSERT INTO OCCURRENCE(NAME) VALUES('ALTERACAO NA QUANTIDADE PRODUZIDA');
INSERT INTO OCCURRENCE(NAME) VALUES('PERDA NA PRODUÇÃO');
INSERT INTO OCCURRENCE(NAME) VALUES('EMBALAGEM DANIFICADA');
INSERT INTO OCCURRENCE(NAME) VALUES('INSUMO DANIFICADO');
INSERT INTO OCCURRENCE(NAME) VALUES('MATERIA PRIMA FORA DO PADRÃO');

INSERT INTO LABOR_COST_TYPE (NAME) VALUES('SALARIO');
INSERT INTO LABOR_COST_TYPE (NAME) VALUES('HORA EXTRA');
INSERT INTO LABOR_COST_TYPE (NAME) VALUES('AUXILIO TRANSPORTE');

INSERT INTO APPORTIONMENT_TYPE (NAME,TYPE) VALUES('ENERGIA ELETRICA',1);
INSERT INTO APPORTIONMENT_TYPE (NAME,TYPE) VALUES('LIMPEZA',0);
INSERT INTO APPORTIONMENT_TYPE (NAME,TYPE) VALUES('AGUA',0); 
...
INSERT INTO product(description, gross_weight,name,net_weight,packaging,line_id,unity_id,validity_days)VALUES('Leite in natura desnatado',1.032,'LEITE IN NATURA DESNATADO',1.032,'',2,'L',0);
...
INSERT INTO product(description, gross_weight,name,net_weight,packaging,line_id,unity_id,validity_days)VALUES('Leite em pó integral desnatado',1,'LEITE EM PO DESNATADO',1,'SC COM 25KG',5,'KG',365);
...
INSERT INTO FORMULATION (COEFFICIENT,DESCRIPTION,PRODUCT_ID) VALUES(1000,'LEITE EM PO',7);
INSERT INTO FORMULATION_ITEMS(FORMULATION_ID,PRODUCT_ID,QUANTITY,ROUND,TYPE,RAW_MATERIAL)VALUES(1,1,8400,0,0,1);
INSERT INTO FORMULATION_ITEMS(FORMULATION_ID,PRODUCT_ID,QUANTITY,ROUND,TYPE,RAW_MATERIAL)VALUES(1,3,40,1,0,0);
INSERT INTO FORMULATION_ITEMS(FORMULATION_ID,PRODUCT_ID,QUANTITY,ROUND,TYPE,RAW_MATERIAL)VALUES(1,4,40,1,1,0);
INSERT INTO FORMULATION_ITEMS(FORMULATION_ID,PRODUCT_ID,QUANTITY,ROUND,TYPE,RAW_MATERIAL)VALUES(1,5,40,1,0,0);
INSERT INTO FORMULATION_ITEMS(FORMULATION_ID,PRODUCT_ID,QUANTITY,ROUND,TYPE,RAW_MATERIAL)VALUES(1,6,0.36,0,0,0);

INSERT INTO FORMULATION (COEFFICIENT,DESCRIPTION,PRODUCT_ID) VALUES(1000,'LEITE EM PO DESNATADO',8);
INSERT INTO FORMULATION_ITEMS(FORMULATION_ID,PRODUCT_ID,QUANTITY,ROUND,TYPE,RAW_MATERIAL)VALUES(2,2,9285,0,0,1);
INSERT INTO FORMULATION_ITEMS(FORMULATION_ID,PRODUCT_ID,QUANTITY,ROUND,TYPE,RAW_MATERIAL)VALUES(2,3,40,1,0,0);
INSERT INTO FORMULATION_ITEMS(FORMULATION_ID,PRODUCT_ID,QUANTITY,ROUND,TYPE,RAW_MATERIAL)VALUES(2,4,40,1,1,0);
INSERT INTO FORMULATION_ITEMS(FORMULATION_ID,PRODUCT_ID,QUANTITY,ROUND,TYPE,RAW_MATERIAL)VALUES(2,5,40,1,0,0);
INSERT INTO FORMULATION_ITEMS(FORMULATION_ID,PRODUCT_ID,QUANTITY,ROUND,TYPE,RAW_MATERIAL)VALUES(2,6,0.36,0,0,0);
...
INSERT INTO EMPLOYEE(NAME,SECTOR_ID) VALUES('ANA',2);
INSERT INTO EMPLOYEE(NAME,SECTOR_ID) VALUES('JONAS',3);

INSERT INTO OPERATIONAL_COST(DATE,DESCRIPTION,PAYMENT_AMOUNT,APPORTIONMENT_TYPE_ID)VALUES(TIMESTAMP WITH TIME ZONE '2021-04-29T00:00:07.12345Z','Conta de Luz Ref 04/2021',1258.87,1);
INSERT INTO OPERATIONAL_COST(DATE,DESCRIPTION,PAYMENT_AMOUNT,APPORTIONMENT_TYPE_ID)VALUES(TIMESTAMP WITH TIME ZONE '2021-04-28T00:00:07.12345Z','Conta de Agua Ref 04/2021',124.56,2);

INSERT INTO FORMULATION_APPORTIONMENT(FORMULATION_ID,APPORTIONMENT_TYPE_ID) VALUES(1,1);
INSERT INTO FORMULATION_APPORTIONMENT(FORMULATION_ID,APPORTIONMENT_TYPE_ID) VALUES(1,2);
INSERT INTO FORMULATION_APPORTIONMENT(FORMULATION_ID,APPORTIONMENT_TYPE_ID) VALUES(1,3);

INSERT INTO FORMULATION_APPORTIONMENT(FORMULATION_ID,APPORTIONMENT_TYPE_ID) VALUES(2,1);
INSERT INTO FORMULATION_APPORTIONMENT(FORMULATION_ID,APPORTIONMENT_TYPE_ID) VALUES(2,2);
INSERT INTO FORMULATION_APPORTIONMENT(FORMULATION_ID,APPORTIONMENT_TYPE_ID) VALUES(2,3);

INSERT INTO FORMULATION_SECTOR(FORMULATION_ID,SECTOR_ID) VALUES(1,1);
INSERT INTO FORMULATION_SECTOR(FORMULATION_ID,SECTOR_ID) VALUES(1,3);

INSERT INTO FORMULATION_SECTOR(FORMULATION_ID,SECTOR_ID) VALUES(2,1);
INSERT INTO FORMULATION_SECTOR(FORMULATION_ID,SECTOR_ID) VALUES(2,3);